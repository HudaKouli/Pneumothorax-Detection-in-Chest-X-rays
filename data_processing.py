...
#Preparing Dataset
csv_file1 = "C:\dataset\siim-acr-pneumothorax\stage_1_test_images.csv"
csv_file2 = "C:\dataset\siim-acr-pneumothorax\stage_1_train_images.csv"
...
if __name__ == '__main__':
    image_dir = "C:\dataset\siim-acr-pneumothorax\png_images"
    mask_dir = "C:\dataset\siim-acr-pneumothorax\png_masks"
...
#Data Normalization based on the training set statistics.
    ...
    #Preparing datasets after normalization based on the training set statistics.
...
#Training 
    ...
    trainer = Trainer(model,
                        ...
                        optimizer, criterion, num_epochs=2)
...
# Early Stopping Parameters
    ...
    trainer_enhanced = EnhancedTrainer(model, train_loader, val_loader, criterion, optimizer, gradient_accumulation_steps=4, num_epochs=21)
